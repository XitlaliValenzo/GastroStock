      ...
      <div class='modal-dialog'>
        <div class='modal-content'>
          <div class='modal-header'>
            <h5 class='modal-title' id='exampleModalLabel'>Solicitud actualizada</h5>
            <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
              <span aria-hidden='true'>&times;</span>
            </button>
          </div>
          <div class='modal-body'>
            <center><p class='lead'>¡La solicitud se actualizo exitosamente!</p>
...
<head>
    ...
    <title>Requisiciones finalizadas</title>
    ...
    <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Requisiciones finalizadas</h1>
                        <br>
                        <hr>
                        <br>
          ...
          WHERE solicitud.estatus = 'finalizada'
          ORDER BY id DESC";
...
<td>
              ...
              echo strftime("%d de %B de %Y", strtotime($row['fecha_solicitud'])); ?>
                                                  ...
                                                  <td>
                                                    <?php setlocale(LC_TIME, 'es_ES', 'Spanish_Spain', 'Spanish'); 
              echo strftime("%d de %B de %Y", strtotime($row['fecha_entrega'])); ?>
                                                </td>
                                                <td><?php echo !empty($row['observaciones']) ? $row['observaciones'] : 'No hay observaciones'; ?></td>
                                              <td>
                                              <i class='fa-solid fa-circle-check' style='color: #00d235;'></i> Finalizado
                                              </td>
            ...
            echo "<tr> <td colspan='7'> <center>Aún no se han realizado requisiciones</center></td></tr>";
          }
        ?>  
