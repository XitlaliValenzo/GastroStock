...
<body class="sb-nav-fixed">
	...
	<div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Editar profesor</h1>
                        <br>
                        <hr>
                        <br>
                        <form action="php_action/profesores.php" method="POST" id="registration" class="registration">
                            <div class="container">
  ...
  <input type="hidden" name="id_profesor" value="<?php echo $data['id_profesor']?>">
  ...
  <div class="d-flex container-fluid justify-content-end">
              ...
              <a href="profesores.php" class="btn btn-outline-info" role="button"><i class="fa-solid fa-arrow-left"></i> Atrás</a>
