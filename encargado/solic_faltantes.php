...
<head>
    ...
    <title>Requisiciones faltantes</title>
    ...
    <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Requisiciones faltantes</h1>
                        <br>
                        <hr>
                        <br>
          ...
          WHERE solicitud.estatus = 'faltantes'
          ORDER BY id DESC";
  ...
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <div class="row align-items-center">
        <img src="../img/icono.png" alt="chef" width="60px" height="60px">
        <h5 class="modal-title" id="exampleModalLabel">Material Faltante</h5>
</div>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      ...
      <div class="modal-body text-justify">
        <ul>
            <?php 
          $query3 = "SELECT articulos.nombre,articulos_perdidos.cantidad AS cantidadFaltante FROM articulos_perdidos 
          ...
          while ($row3 = $result3->fetch_assoc()) { ?>
            <li><?php echo $row3['cantidadFaltante'] . ' - ' . $row3['nombre'] ?></li>
          <?php }
        ?>
        </ul>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-dismiss="modal"><i class="fa-solid fa-circle-check"></i> Ok</button>
              ...
              echo strftime("%d de %B de %Y", strtotime($row['fecha_solicitud'])); ?>
                                                ...
                                                <td>
                                                    <?php setlocale(LC_TIME, 'es_ES', 'Spanish_Spain', 'Spanish'); 
              echo strftime("%d de %B de %Y", strtotime($row['fecha_reposicion'])); ?>
                                                </td>
                                                <td>
...
<div class="modal fade" id="cambiarEstatusModal_<?php echo $i_equipo ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <form action="actualizar_estatus_faltantes.php" method="POST">
      <div class="modal-body text-justify">
