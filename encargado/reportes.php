  ...
  <div class="modal-dialog">
    ...
    <div class="form-group" id="campo_oculto_fecha_<?php echo $i ?>" style="display: none">
      ...
      <button type="submit" class="btn btn-danger">Generar reporte</button>
        ...
        <a href="../administrador/fpdf186/reporteGeneral.php" target="_blank"><button type="button" class="btn shadow " style="border-radius: 50px;background-color: #2FC463;color:#fff;"><i class="fa-solid fa-file"></i> Reporte General</button></a>
