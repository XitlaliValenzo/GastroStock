  ...
  $(document).ready(function(){
            ...
            <ul class="navbar-nav ml-auto mr-0 mr-md-3 my-2 my-md-0">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <form action="administrador/cambiar_password.php" method="POST">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-image: url('img/fondo-menu.jpg');background-repeat: no-repeat;background-size: cover;background-position: center center;margin: 0px;position: relative;">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="nav" >
                            ...
                            <a class="nav-link" href="home.php" id="nav-link">
                                ...
                                <a class="nav-link" href="administrador/encargados.php" id="nav-link">
                        ...
                        ?>
                                    ...
                                    <div class="collapse" id="collapseLayoutsGrupos" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="administrador/grupos.php">Grupos&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/profesores.php">Profesores&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/materias.php">Materias&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                ...
                                <a class="nav-link" href="administrador/alumnos.php" id="nav-link">
                        ...
                        ?>
                                ...
                                <a class="nav-link" href="administrador/solicitudes.php" id="nav-link">
                        ...
                        ?>
                                ...
                                <a class="nav-link" href="administrador/materiales.php" id="nav-link">
                        ...
                        ?>
                                ...
                                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts" id="nav-link">
                                    ...
                                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="administrador/inv_actual.php">Actual&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                            $query = "SELECT COUNT(id_articulo) as total FROM articulos WHERE estatus = 'activo'";
                            $result = $con -> query($query);
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/inv_donado.php">Material donado&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/inv_perdido.php">Material perdido&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/inv_danado.php">Material dañado&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/inv_equipo.php">Equipo&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                  ...
                  ORDER BY id_articulo) AS union_table";
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/inv_mantenimiento.php">Mantenimiento / Reparación&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                            ...
                                            <a class="nav-link" href="administrador/inv_eliminado.php">Baja de material&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-danger">
                                                <?php
                        ...
                        ?>
                                    ...
                                    <a class="nav-link" href="administrador/reportes.php" id="nav-link">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-md-6">
                                <div class="card shadow rounded text-white mb-4" style="background-color: #5C9287;">
                                    <div class="card-body"><i class="fa-solid fa-user" style="color: #ffffff;"></i> Encargados&nbsp;&nbsp;
                        ...
                        ?>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="administrador/encargados.php">Ver detalles</a>
                        ...
                        ?>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="administrador/inv_actual.php">Ver detalles</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
									</div>
								</div>
							</div>
                            <div class="col-xl-4 col-md-6">
                                <div class="card text-white mb-4 shadow rounded" style="background-color: #5C9287">
                                    <div class="card-body"><i class="fa-solid fa-clock-rotate-left" style="color: #ffffff;"></i> Historial de requisiciones&nbsp;&nbsp;
                                            <span class="badge badge-pill badge-light">
                                                <?php
                            $query = "SELECT COUNT(id) as total FROM solicitud";
                            $result = $con -> query($query);
                        ...
                        ?>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="administrador/solicitudes.php">Ver detalles</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
									</div>
								</div>
							</div>
                        ...
                        <br><br>
                        <div class="card mb-4">
                            <div class="card-header"><i class="fa-solid fa-store"></i> Inventarios</div>
                            <div class="card-body">
    ...
    <div class="card text-center shadow p-3 mb-5 bg-white rounded" style="border: none">
      <div class="card-body">
        ...
        <a href="administrador/inv_actual.php" class="btn btn-outline-danger">Ver inventario</a>
      </div>
    </div>
  </div>
  <div class="col mb-4">
    <div class="card text-center shadow p-3 mb-5 bg-white rounded" style="border: none">
      <div class="card-body">
        <h5 class="card-title">Material donado</h5>
        <p class="card-text" style="font-size: 30px; color: #FD2933; font-weight: bold;">
            <?php
                             $query = "SELECT COUNT(id_articulo) as total FROM articulos INNER JOIN articulos_donados ON articulos.id_articulo = articulos_donados.articulo_donado WHERE articulos.estatus = 'activo' ";
                            $result = $con -> query($query);
        ...
        <a href="administrador/inv_donado.php" class="btn btn-outline-danger">Ver inventario</a>
      </div>
    </div>
  </div>
  <div class="col mb-4">
    <div class="card text-center shadow p-3 mb-5 bg-white rounded" style="border: none">
      <div class="card-body">
        <h5 class="card-title">Material perdido</h5>
        <p class="card-text" style="font-size: 30px; color: #FD2933; font-weight: bold;">
            <?php
                           $query = "SELECT COUNT(id_articulo) as total FROM articulos INNER JOIN articulos_perdidos ON articulos.id_articulo = articulos_perdidos.articulo_perdido WHERE articulos.estatus = 'activo'";
                            $result = $con -> query($query);
        ...
        <a href="administrador/inv_perdido.php" class="btn btn-outline-danger">Ver inventario</a>
      </div>
    </div>
  </div>
    </div>
    ...
    <div class="card text-center shadow p-3 mb-5 bg-white rounded" style="border: none">
      <div class="card-body">
        <h5 class="card-title">Material dañado</h5>
        <p class="card-text" style="font-size: 30px; color: #FD2933; font-weight: bold;">
            <?php
                            $query = "SELECT COUNT(id_articulo) as total FROM articulos INNER JOIN articulos_danados ON articulos.id_articulo = articulos_danados.articulo_danado WHERE articulos.estatus = 'activo'";
                            $result = $con -> query($query);
        ...
        <a href="administrador/inv_danado.php" class="btn btn-outline-danger">Ver inventario</a>
      </div>
    </div>
  </div>
  <div class="col mb-4">
    <div class="card text-center shadow p-3 mb-5 bg-white rounded" style="border: none">
      <div class="card-body">
        ...
        <a href="administrador/inv_equipo.php" class="btn btn-outline-danger">Ver inventario</a>
      </div>
    </div>
                            </div>
                            <div class="col mb-4">
    <div class="card text-center shadow p-3 mb-5 bg-white rounded" style="border: none">
      <div class="card-body">
        <h5 class="card-title">Mantenimiento/reparación</h5>
        <p class="card-text" style="font-size: 30px; color: #FD2933; font-weight: bold;">
           <?php
                            $query = "SELECT COUNT(id_articulo) as total FROM articulos_reparacion INNER JOIN articulos ON articulos_reparacion.articulo_reparacion = articulos.id_articulo WHERE articulos.estatus ='activo' ";
                            $result = $con -> query($query);
