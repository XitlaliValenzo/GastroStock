<?php
		...
		if ($count == 1) {
			header("Location: ../form_alumnos.php?m=1");
		} else {
			...
			$query = "INSERT INTO usuarios (nombre, email, password, grupo, matricula, role, activo) VALUES ('$nombre', '$email', '$passHash', '$grupo', '$matricula', 'alumno',1)";

			if (mysqli_query($con, $query)) {
				header("Location: ../alumnos.php?m=1");
			} else {
